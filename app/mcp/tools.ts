...
Outbound message nodes. Inputs: flow in, message (value — overrides config.message when connected). Output: flow out. Discord truncates messages to 2000 chars; a message that is a data:image/… URL is uploaded as a file attachment instead of text.
