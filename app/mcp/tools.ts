...
Outbound action nodes. Inputs: flow in, plus a message value port on actions that take a message (it overrides config.message when connected; actions without a "message" config field have no message port). Output: flow out. Messages truncate to the platform's cap (Discord 2000 chars, Telegram 4096); a message that is a data:image/… URL is uploaded as a file attachment/photo instead of text.
